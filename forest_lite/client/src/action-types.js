...
export const SET_NATURAL_EARTH_FEATURE = 'SET_NATURAL_EARTH_FEATURE'
export const SET_QUADKEYS = 'SET_QUADKEYS'

// IndexedDB action types
export const GET_NATURAL_EARTH_FEATURE = 'GET_NATURAL_EARTH_FEATURE'
export const GOT_NATURAL_EARTH_FEATURE = 'GOT_NATURAL_EARTH_FEATURE'
